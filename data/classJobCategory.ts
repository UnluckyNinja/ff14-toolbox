export const classJobCategory: Record<string, string> = {
  0: '',
  1: '所有职业',
  2: '剑术师',
  3: '格斗家',
  ...
  162: '骑士 武僧 战士 龙骑士 吟游诗人 白魔法师 黑魔法师 召唤师 学者 忍者 机工士 暗黑骑士 占星术士 武士 赤魔法师 绝枪战士 舞者',
...
export const equipSlotCategory: Record<string, string> = {
  // 0: '无法装备',
  // 1: '主手',
  // 2: '副手',
  3: '头部',
